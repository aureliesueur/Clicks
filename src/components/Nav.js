...
function Nav({cart, isLoggedIn, updateConnexion}) {
  ...
  return (
    <nav className="menu">
      ...
      <ul className="menu__links">
        ...
        <Link to="/panier" className="menu__link basket"><FontAwesomeIcon icon={faShoppingBasket}/><span className="basket__nb">{basket}</span></Link>
        <Link to="/blog" className="menu__link">Blog</Link>
      </ul>
      <Connexion isLoggedIn={isLoggedIn} updateConnexion={updateConnexion} />
    </nav>
  );
}
